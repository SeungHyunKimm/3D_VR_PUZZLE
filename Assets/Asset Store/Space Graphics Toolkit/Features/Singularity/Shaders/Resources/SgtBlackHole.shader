...
#define _UNLIT 1
         ...
         struct VertexToPixel
         {
            ...
            struct TessVertex 
            {
               ...
               #if _HDRP && _PASSMOTIONVECTOR || (_PASSFORWARD && defined(_WRITE_TRANSPARENT_MOTION_VECTOR))
                  float4 previousPositionOS : TEXCOORD12; // Contain previous transform position (in case of skinning for example)
                  float4 motionVectorCS : TEXCOORD13;
               #endif
