...
Shader "Space Graphics Toolkit/Terrain Planet"
{
   Properties
   {
	...
	[NoScaleOffset][Normal]_BakedDetailMapR_Ext_1("	Normal R", 2D) = "bump" {}
	[NoScaleOffset][Normal]_BakedDetailMapG_Ext_1("	Normal G", 2D) = "bump" {}
	[NoScaleOffset][Normal]_BakedDetailMapB_Ext_1("	Normal B", 2D) = "bump" {}
	[NoScaleOffset][Normal]_BakedDetailMapA_Ext_1("	Normal A", 2D) = "bump" {}
	...
	[NoScaleOffset][Normal]_BakedDetailMapR_Ext_2("	Normal R", 2D) = "bump" {}
	[NoScaleOffset][Normal]_BakedDetailMapG_Ext_2("	Normal G", 2D) = "bump" {}
	[NoScaleOffset][Normal]_BakedDetailMapB_Ext_2("	Normal B", 2D) = "bump" {}
	[NoScaleOffset][Normal]_BakedDetailMapA_Ext_2("	Normal A", 2D) = "bump" {}
...
#   define UNITY_LOOP
	...
	sampler2D _BakedDetailMapR_Ext_1;
	sampler2D _BakedDetailMapG_Ext_1;
	sampler2D _BakedDetailMapB_Ext_1;
	sampler2D _BakedDetailMapA_Ext_1;
	...
	void Ext_SurfaceFunction5(inout Surface o, inout ShaderData d)
	{
		...
		#if _DETAIL_R
		ContributeDetail(o, _BakedDetailMapR_Ext_1, coords, polar, max_height, noise, d.blackboard.detailMask.r * _BakedDetailScaleR_Ext_1 * fade);
		#endif
		#if _DETAIL_G
		ContributeDetail(o, _BakedDetailMapG_Ext_1, coords, polar, max_height, noise, d.blackboard.detailMask.g * _BakedDetailScaleG_Ext_1 * fade);
		#endif
		#if _DETAIL_B
		ContributeDetail(o, _BakedDetailMapB_Ext_1, coords, polar, max_height, noise, d.blackboard.detailMask.b * _BakedDetailScaleB_Ext_1 * fade);
		#endif
		#if _DETAIL_A
		ContributeDetail(o, _BakedDetailMapA_Ext_1, coords, polar, max_height, noise, d.blackboard.detailMask.a * _BakedDetailScaleA_Ext_1 * fade);
		#endif
	#endif
	}


	sampler2D _BakedDetailMapR_Ext_2;
	sampler2D _BakedDetailMapG_Ext_2;
	sampler2D _BakedDetailMapB_Ext_2;
	sampler2D _BakedDetailMapA_Ext_2;
	...
	void Ext_SurfaceFunction6(inout Surface o, inout ShaderData d)
	{
		...
		#if _DETAIL_R
		ContributeDetail(o, _BakedDetailMapR_Ext_2, coords, polar, max_height, noise, d.blackboard.detailMask.r * _BakedDetailScaleR_Ext_2 * fade);
		#endif
		#if _DETAIL_G
		ContributeDetail(o, _BakedDetailMapG_Ext_2, coords, polar, max_height, noise, d.blackboard.detailMask.g * _BakedDetailScaleG_Ext_2 * fade);
		#endif
		#if _DETAIL_B
		ContributeDetail(o, _BakedDetailMapB_Ext_2, coords, polar, max_height, noise, d.blackboard.detailMask.b * _BakedDetailScaleB_Ext_2 * fade);
		#endif
		#if _DETAIL_A
		ContributeDetail(o, _BakedDetailMapA_Ext_2, coords, polar, max_height, noise, d.blackboard.detailMask.a * _BakedDetailScaleA_Ext_2 * fade);
		#endif
	#endif
	}
