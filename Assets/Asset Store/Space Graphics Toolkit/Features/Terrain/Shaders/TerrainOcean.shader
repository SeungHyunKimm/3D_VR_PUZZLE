...
#define REQUIRE_OPAQUE_TEXTURE
	...
	void Ext_ModifyVertex0(inout VertexData v, inout ExtraV2F d)
	{
		...
		d.extraV2F0.xyz = mul(mul(GetObjectToWorldMatrix(), UNITY_MATRIX_V), v.vertex).xyz;
	}
	...
	void Ext_SurfaceFunction7(inout Surface o, inout ShaderData d)
	{
		...
		float2 bentScrUV = d.screenUV + o.Normal.xy * _Refraction * log(1.0f + d.blackboard.worldDistance + opticalDepth) / _ScreenParams.xy;
